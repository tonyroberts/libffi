...
wrapper script during configuration like so:
    ...
    path/to/configure CC=path/to/msvcc.sh CXX=path/to/msvcc.sh LD=link CPP="cl -nologo -EP" CXXCPP="cl -nologo -EP"
...
project's clang-cl compiler, like below:
    ...
    path/to/configure CC="path/to/msvcc.sh -clang-cl" CXX="path/to/msvcc.sh -clang-cl" LD=link CPP="clang-cl -EP" CXXCPP="clang-cl -EP"
